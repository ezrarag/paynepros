                    ...
                    return (
                      ...
                      >
                        ...
                        {showIntakeNotesForRow && (
                          <div className="mt-2 rounded-md border bg-white/60 px-2 py-2 text-xs text-muted-foreground dark:border-slate-700 dark:bg-slate-900/60 dark:text-slate-300">
                            <span className="font-medium text-foreground dark:text-slate-100">Client note:</span>{" "}
                            {intakeNotes}
                          </div>
                        )}
                      </div>
